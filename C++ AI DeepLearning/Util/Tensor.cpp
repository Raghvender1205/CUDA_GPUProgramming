...
namespace AI {
    ...
    template <typename T>
    void Tensor<T>::shape(const int width) {
        ensure(width != 0);
        clear();
        _width = width;
        _height = 1;
    ...
    template <typename T>
    void Tensor<T>::shape(const int width, const int height) {
    ...
    template <typename T>
    void Tensor<T>::shape(const int width, const int height, const int depth) {
