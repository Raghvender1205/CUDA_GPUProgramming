'''
Mandelbrot set is a set of complex numbers C with Fn as f(z) = z**2 + c. which does not diverge
when iterated from z = 0, for which the sequence f(0), f(f(0)) remains bounded in absolute Value.
