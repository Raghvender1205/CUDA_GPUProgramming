...
namespace AI {
    ...
    public:
        ...
        void shape(const int width);
        void shape(const int width, const int height);
        void shape(const int width, const int height, const int depth);
